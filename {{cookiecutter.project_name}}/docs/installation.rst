...
.. code-block:: console
    ...
    $ git clone git://github.com/ESSS/{{ cookiecutter.package_name }}

Or download the `tarball`_:

.. code-block:: console

    $ curl  -OL https://github.com/ESSS/{{ cookiecutter.package_name }}/tarball/master
...
.. _Github repo: https://github.com/ESSS/{{ cookiecutter.package_name }}
.. _tarball: https://github.com/ESSS/{{ cookiecutter.package_name }}/tarball/master
