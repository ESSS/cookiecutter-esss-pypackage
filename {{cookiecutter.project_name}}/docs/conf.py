...
project = u"{{ cookiecutter.package_name | capitalize }}"
...
latex_documents = [
    (master_doc, "{{ cookiecutter.package_name}}.tex", u"{{ cookiecutter.package_name | capitalize }} Documentation", u"ESSS", "manual")
]
...
man_pages = [(master_doc, "{{ cookiecutter.package_name }}", u"{{ cookiecutter.package_name | capitalize }} Documentation", [author], 1)]
